...

{
  ...
  methods: {
    //显示时间选择器
    onShowDatePicker: function onShowDatePicker() {var _this = this;
      uni.showLoading({
        mask: true });
    ...
    //完成时间选择
    onSelected: function onSelected(e) {var _this2 = this;
      ...
      if (e) {
        ...
        //时间戳转年-月-日 时:分:秒
        var selectDateTime = (0, _index.formatTimeStamp)(selectTimeStamp, 'yyyy-MM-dd hh:mm:ss');

        if (currentTimeStamp < selectTimeStamp) {
          this.$nextTick(function () {
            _this2.selectDateTime = selectDateTime;
            console.log('选择的时间戳为:', selectTimeStamp);
            console.log('选择的时间为:', _this2.selectDateTime);
          });
        } else {
          uni.showToast({
            title: '请选择未来的时间段',
    ...
    //指定时间的显示与隐藏
    changeTimeSwitch: function changeTimeSwitch(e) {var _this3 = this;
      this.$nextTick(function () {
        _this3.timeChecked = !_this3.timeChecked;
      });
    },
    //指定位置的显示与隐藏
    changeLocationSwitch: function changeLocationSwitch() {var _this4 = this;
      this.$nextTick(function () {
        _this4.locationChecked = !_this4.locationChecked;
      });
    },

    //指定人或群的显示与隐藏
    changePersonSwitch: function changePersonSwitch() {var _this5 = this;
      this.$nextTick(function () {
        _this5.personChecked = !_this5.personChecked;
      });
    },
    showFreq: function showFreq() {var _this6 = this;
      uni.showActionSheet({
        itemList: this.timeFreqList,
        success: function success(res) {
          switch (res.tapIndex) {
            case 0:
              _this6.timeFreqIndex = 0;
              break;
            case 1:
              _this6.timeFreqIndex = 1;
              break;
            case 2:
              _this6.timeFreqIndex = 2;
              break;}
    ...
    //失焦
    isBlur1: function isBlur1() {var _this7 = this;
      setTimeout(function () {
        _this7.showDel1 = false;
      }, 80);
    },
    isBlur2: function isBlur2() {var _this8 = this;
      setTimeout(function () {
        _this8.showDel2 = false;
      }, 80);
    },

    //清除input内容
    resetInput1: function resetInput1() {var _this9 = this;
      this.$nextTick(function () {
        _this9.remindInfo.title = '';
      });
    },
    resetInput2: function resetInput2() {var _this10 = this;
      this.$nextTick(function () {
        _this10.remindInfo.content = '';
      });
    } },
