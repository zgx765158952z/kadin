...
var _FriendInfo = _interopRequireDefault(__webpack_require__(/*! ./components/content/friend/FriendInfo.vue */ 420));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _FriendInfo_vue_vue_type_template_id_31292e7a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FriendInfo.vue?vue&type=template&id=31292e7a& */ 421);
/* harmony import */ var _FriendInfo_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FriendInfo.vue?vue&type=script&lang=js& */ 423);
...
/* harmony import */ var _FriendInfo_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FriendInfo.vue?vue&type=style&index=0&lang=scss& */ 425);
...

{
  ...
  (0, _vuex.mapActions)(['imAction']), {
    ...
    previewFriendHeadImg: function previewFriendHeadImg() {
      var imgPath = "".concat(_helper.imgBaseUrl).concat(this.friendCard[this.friendAccount].friendFaceImage);
      uni.previewImage({
        urls: [imgPath],
        longPressActions: {
          itemList: ['保存到相册'],
    ...
    doGetFriendInfo: function doGetFriendInfo() {var _this = this;
      (0, _addfriend.getFriendInfo)("?myAccount=".concat(this.userInfo.user.userAccount, "&friendAccount=").concat(this.friendAccount)).then(function (res) {
        ...
        Object.assign({}, _this.friendCard, tempFriendCard);
    ...
    toMyDynamic: function toMyDynamic(params) {
      ...
      uni.navigateTo({
        url: "/components/content/dynamic/MyDynamic?account=".concat(account, "&friendRemarkName=").concat(this.friendCard[this.friendAccount].friendRemarkName) });
